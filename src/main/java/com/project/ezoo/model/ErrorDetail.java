...
public class ErrorDetail {
    ...
    /**
     * Date and time stamp for the error
     */
    private Date timestamp;

    /**
     * A message for developers about this error message, thing like class and code causing the error.
     ...
     *
     * @return A detailed message (String) about this error suitable for reqular users, clients
     */
     ...
     *
     * @return The date and time (Date) when this happened
     */
    ...
    /**
     * Setter for the date and time the error happened
     *
     * @param timestamp The changed date and time (Date) when this error happened
     */
     ...
     *
     * @param developerMessage The new message for developer's about this error message (String)
     */
